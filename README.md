# MuzFlow: веб-сервис управления поставками и заказами

MuzFlow - курсовой проект веб-сервиса для оптовой компании музыкальной тематики. Система помогает вести контрагентов, музыкальные товары, складские остатки, заказы клиентов и поставки от поставщиков.
...
- Авторизация администратора и оператора
- Управление контрагентами, музыкальными товарами и складами
- Создание заказов с проверкой доступного остатка
- Создание и приемка поставок
